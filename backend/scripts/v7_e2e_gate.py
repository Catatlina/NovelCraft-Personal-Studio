    ...
    return {
        "states": [
            {
                ...
                "value": {
                    ...
                    "pov": "第三人称限知视角，跟随江砚",
                    "target_chapters": 50,
                    "structure": "三幕：第一幕 天牢七日(1-10) 觉醒与越狱；第二幕 流亡查案(11-30) 点亮归墟灯、追查星录篡改；第三幕 真相与终局(31-50) 完全揭示、对决收束",
                },
                "confidence": 0.98,
            },
            {
            ...
            },
            {
                ...
                "value": {
                    ...
                    "reveal_plan": "第1-3章埋线，第7章半揭（点亮第一盏灯照出密道与灭门夜一角），第10章不完全揭示（逃出天牢但遗忘母亲面容）；第11-30章江砚流亡查案、结识盟友、点亮第二至五盏灯，侧面逼近真相；第31-44章点亮第六至八盏灯，真相逐步拼合；第45章前后完全揭示'沈观澜篡改星录、嫁祸江家'；第46-50章当众揭伪、大阵崩解、终局收束",
                },
                "confidence": 0.9,
            },
        ],
        "goals": [
            ...
            },
            {
                "type": "arc",
                "name": "第二幕：流亡查案",
                "description": "江砚与阿箬流亡江湖，追查星录篡改真相，点亮第二至五盏归墟灯，结识游方术士老辛等盟友，沈观澜的网逐渐收紧。",
                "target_chapter": 30,
                "priority": 85,
            },
            {
                "type": "arc",
                "name": "第三幕：真相与终局",
                "description": "江砚集齐更多归墟灯，第45章前后完全揭示真相，闯观星台当众揭伪，与沈观澜最终对决，终局收束。",
                "target_chapter": 50,
                "priority": 90,
            },
            {
                "type": "chapter_goal",
                "name": "结识老辛",
                "description": "流亡途中结识游方术士老辛，对方认出归墟灯，引出守灯人一族与阿箬身世。",
                "target_chapter": 16,
                "priority": 70,
            },
            {
            ...
            },
            {
                "type": "chapter_goal",
                "name": "完全揭示真相",
                "description": "点亮第九盏灯，完整真相大白——沈观澜篡改星录、嫁祸江家。",
                "target_chapter": 45,
                "priority": 95,
            },
        ],
        "constraints": [
            ...
            },
            {
                ...
                "name": "真相不得提前全揭",
                "value": {
                    "rule": "第40章之前不得完整写出'沈观澜篡改星录'这一真相，只能给出侧面线索；第40-45章可逐步揭示，第45章前后可完全揭示。",
                },
                "severity": "error",
            },
            {
        ...
        "outlines": {
            ...
            # ── 第二幕：流亡查案（11-30）──
            11: "逃出天牢后江砚与阿箬藏身城外破庙，江砚第一次在日光下使用归墟之眼，看见沿途亡魂的执念。",
            12: "阿箬用饭盒盖写下'星录在观星台'，江砚意识到要翻案必须重返钦天监。",
            13: "二人北上途中遇流民，江砚从民间版本拼出当年灭门夜的另一面。",
            14: "江砚点亮第二盏归墟灯，献出一段与父亲有关的记忆，照出灭门夜更多细节。",
            15: "沈观澜派人沿驿道追捕，江砚第一次正面见识'改命之术'的代价。",
            16: "二人结识游方术士老辛，对方认出归墟灯，提出交易。",
            17: "老辛讲述归墟灯的来历与守灯人一族，阿箬的身世浮现。",
            18: "江砚借第三盏灯照出当年星录被篡改的痕迹，记忆献祭让他忘了老辛的脸。",
            19: "追兵至，江砚被迫再次动用归墟之眼，代价加重，头发又白一截。",
            20: "三人误入险地，江砚在生死间悟到'荧惑守心'星象的真正含义。",
            21: "阿箬的噤声咒出现松动迹象，她第一次发出模糊音节。",
            22: "江砚以星象推演反推沈观澜的布局，预感对方下一步动作。",
            23: "老辛背叛又回流，揭示他也是被沈观澜所害，三人暂结同盟。",
            24: "江砚点亮第四盏灯，照出沈观澜篡改星录的具体手法。",
            25: "同盟潜入钦天监外哨，截获密文，证实国师以活人气数续国祚。",
            26: "密文暴露身份，哨站被毁，江砚肩受重伤。",
            27: "养伤期间阿箬用昼间短暂开口，说出守灯人最后的嘱托。",
            28: "江砚借第五盏灯窥见父亲临刑前的完整记忆，悲恸但坚定。",
            29: "沈观澜设局引江砚入城，江砚将计就计。",
            30: "江砚乔装混入钦天监外围，归墟之眼第一次照见观星台内部的星图。",
            # ── 第三幕：真相与终局（31-50）──
            31: "江砚在观星台外辨认星图，发现'荧惑守心'是人为布置而非天象。",
            32: "阿箬彻底破除噤声咒，说出当年守护灯时被国师下的咒全文。",
            33: "江砚点亮第六盏灯，照出星录原貌与篡改处的对照。",
            34: "老辛为掩护二人牺牲，江砚立誓完成其遗愿。",
            35: "沈观澜主动现身，一场表面客气实则致命的对话，抛出招降。",
            36: "江砚拒绝，沈观澜启动'改命大阵'，北境戎狄压境作乱。",
            37: "江砚借第七盏灯照出大阵的核心与破法。",
            38: "阿箬以守灯人秘法助江砚稳住归墟之眼，二人羁绊加深。",
            39: "江砚联络民间旧部与受压迫的术士，组建薄弱的反抗网络。",
            40: "点亮第八盏灯，照出灭门夜沈观澜亲自动手的画面——几乎完整真相。",
            41: "反抗网络遭重创，江砚被迫转入地下，伙伴离散。",
            42: "江砚在绝境中重新推演星图，找到沈观澜命门。",
            43: "阿箬为护灯受伤，江砚献出更多记忆换她一命。",
            44: "江砚集齐破阵所需，定下闯观星台之夜。",
            45: "闯台之夜前半，江砚点亮第九盏灯，完整真相大白——沈观澜篡改星录、嫁祸江家。",
            46: "观星台上江砚与沈观澜对峙，以完整星录与原版对照当众揭伪。",
            47: "改命大阵将崩，沈观澜困兽之斗，江砚以归墟之眼照出其命门。",
            48: "大阵崩解，北境危机暂缓，沈观澜殒落前说出更深的秘密。",
            49: "江砚以最后一点阳寿归还部分记忆，与阿箬回望归墟灯的去向。",
            50: "终局：新朝星象重定，江砚放下观星郎身份，携阿箬与残灯远走，留白收束。",
        },
    }
...
async def main() -> int:
    ...
    for i in range(args.chapters):
        ...
        async with Session() as session:
            ...
            summary["chapter_text_full"] = text_body
