...
def _provider_output(task_type: str) -> dict:
    ...
    outputs = {
        "plan_idea": {"idea_expanded": "一个作者发现自己写下的故事正在现实中发生，他必须夺回人生的叙事权。", "core_hook": "写下的字会改变现实。", "target_audience": "悬疑脑洞读者", "title_candidates": ["《回声来信》", "《执笔者》", "《删章之后》"], "source_facts": ["主角是作者", "文字影响现实", "必须夺回叙事权"], "design_additions": [], "forbidden_changes": ["不得改变主角职业", "不得取消能力代价", "不得用巧合破局"], "downstream_deliverables": ["生成分卷总纲、章节细纲和第一章正文"], "creative_bible": creative_bible},
