...
def upgrade():
    ...
    indexes = [
        ...
        "CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_versions_content ON versions(entity_id)",
        "CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_versions_user ON versions(author_id)",
        ...
        "CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_entity_states_content ON entity_states(chapter_id)",
...
def downgrade():
    for idx in [
        ...
        "idx_contents_parent_type", "idx_contents_project",
