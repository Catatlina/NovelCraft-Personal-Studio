...
def upgrade():
    ...
    for sql in indexes:
        try:
            ...
            import logging
            logging.getLogger("alembic").warning(f"Index creation skipped: {e}")
...
def downgrade():
    for idx in [
        ...
        "idx_publish_records_content", "idx_run_nodes_run",
        "idx_ai_calls_run", "idx_ai_calls_project",
        "idx_contents_parent_type", "idx_contents_project",
        "idx_knowledge_items_kind", "idx_knowledge_items_project",
        "idx_entity_states_updated",
