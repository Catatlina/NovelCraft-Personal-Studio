    ...
    async def plan_scene(
        ...
        *,
        ...
        prompt = (
            ...
            # 番茄爽文加码：章节标题番茄化（强化版）
            "chapter_title 必须是 2-12 字的短标题，【必须有番茄感，必须有冲击力】！"
            "【绝对不能】太平淡、太文学、太文艺，不能像散文标题。"
            "好的番茄标题（必须参考）："
            "《你也配叫天才？》《全场死寂》《系统觉醒，百倍返还！》《他居然敢动手》"
            "《废物竟是大佬》《门后是什么》《打脸了》《这就是底牌？》《谁敢动他？》《瞬间崩溃》"
            "差的标题（绝对不能写）："
            "《雨夜来客》《初遇》《成长》《转折》《新的开始》《往事》《远方》《岁月》"
            "番茄标题 4 大范式："
            "1. 冲突前置型：把最激烈的冲突直接放在标题里（《你也配？》《他敢动手？》）"
            "2. 反转型：前后反差巨大，制造悬念（《废物竟是大佬》《废柴逆袭》）"
            "3. 爽点直给型：直接告诉读者这章有爽点（《全场傻眼》《百倍返还》）"
            "4. 悬念型：抛出一个问题，让读者想点进去看（《门后是什么》《谁来了？》）"
            "【重要】chapter_title 必须让读者一眼就想点进去，知道这章有好戏看！"
