...
PROMPT_SEEDS = [
    ...
    ("bootstrap.gen_titles", "3.5.0", "deepseek",
...
- P1-4 质量整改：爽感冲击力——书名要让人一眼就觉得"爽"、"牛逼"、"想看"
  爽感书名参考：《我在精神病院学斩神》《开局签到荒古圣体》《我有一座恐怖屋》《全球高武》《万族之劫》
  核心：要有碾压感、越级感、震惊感、扮猪吃虎感，让读者一眼就知道主角很牛逼
...
5. P1-4 质量整改：爽感冲击力维度——书名必须有爽感钩子，不能太平淡
   - 好的书名：让读者一眼就觉得"主角很牛逼"、"这书肯定爽"
   - 差的书名：读完没感觉，不知道爽点在哪，记不住
   - 宁可有点"土"但有爽感，也不要"文艺"但没钩子
...
6. P1-4 质量整改：爽感冲击力——5个书名中至少3个要有明确的爽感钩子（碾压/越级/震惊/扮猪吃虎/开局无敌等）
   不能5个都是"文艺范"或"平淡流"，网文书名首先要让读者觉得"爽"
...
输出 JSON: {"title_candidates":["《书名一》","《书名二》","《书名三》","《书名四》","《书名五》]}"""),
    ...
    ("bootstrap.gen_synopsis", "3.4.0", "deepseek",
...
6. P1-4 质量整改：冲突前置/爽点前置——简介前30字就要抛出核心冲突或爽点钩子
   - 不要铺垫半天才进入主题，读者划走只需要1秒
   - 开头就要有"卧槽，这也行？"、"主角好牛逼"的感觉
   - 参考番茄爆款简介：第一句就打脸/逆袭/亮金手指
7. P1-4 质量整改：金手指强度展示——简介必须让读者知道金手指有多强
   - 不能只说"主角有个系统"，要说清楚系统能干嘛、有多牛逼
   - 要有碾压感、越级感，让读者期待看主角装逼

卖点要求：
1. 每个卖点对应一个读者付费动机（爽感/悬念/情感/新奇/共鸣）
2. 具体可营销，不是「好看」「精彩」这类空话
3. 用 oh-story 情绪矩阵：从爽感释放/逆袭打脸/悬疑解密/情感治愈/新奇探索/知识获取中选
4. P1-4 质量整改：至少2个卖点是爽感导向的（碾压/越级/打脸/震惊全场等）
...
输出格式：用空行分隔段落；每个段落 1-3 句话。输出 JSON: {"text":"去AI味后的文本"}"""),
    ...
    ("narrative.gen_next_chapter", "3.8.0", "deepseek",
