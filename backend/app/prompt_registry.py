...
输出格式：用空行分隔段落；每个段落 1-3 句话。输出 JSON: {"text":"润色后的文本"}"""),
...
输出格式：用空行分隔段落；每个段落 1-3 句话。输出 JSON: {"text":"改写后的文本"}"""),
...
输出格式：用空行分隔段落；每个段落 1-3 句话。输出 JSON: {"text":"续写文本"}"""),
...
body 至少 12 段，建议 15-25 段；每段 1-3 句；总字数不得低于 1500 字；低于 1500 字视为失败。"""),
