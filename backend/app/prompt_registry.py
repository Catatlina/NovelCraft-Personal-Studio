...
输出 JSON: {"scenes":[{"title":"场景名","beat":"转折","goal":"目标","setting":"环境","pov":"视角人物"}]}"""),
    ...
    ("authoring.chapter_skeleton", "1.3.0", "deepseek",
...
1. 【开场状态与本章目标】100-140 字；
2. 【场景一·起压】100-140 字，写清触发、人物行动、阻力和结果；
3. 【场景二·选择】100-140 字，写清主角面对的选择、代价和局势变化；
4. 【场景三·升级】100-140 字，写清对手/环境如何反应以及新的可见信息；
5. 【场景四·兑现】100-140 字，写清本章给读者的具体结果和余波；
6. 【人物、主线与伏笔】100-140 字，写明谁改变、哪条线推进、什么事实待确认；
7. 【章尾钩子与人工执行清单】100-140 字，写清下一章压力和作者落笔时必须补出的细节。
每个小节至少 100 字，并且必须包含具体行动、结果、人物选择或可验证线索；7 个小节合计至少 700 个可见字。若检查后只有 500-600 字，继续向场景二至五补充新的选择、代价、反应和可见变化，不要用空泛形容词凑字数。只要 skeleton_text 未达到 700 个可见字数，任务就算失败。
