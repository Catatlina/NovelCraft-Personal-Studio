...
- 已定位并本地修复：仅对“原首句未分类、前 160 字内出现可见动作”的短环境引子按动作开场处理；真正静态开场、动作过晚、身体疼痛模板仍阻断。定向回归 `96 passed`，最终后端全量 `1183 passed, 138 skipped, 1 xpassed, 2 warnings`；修复仍待提交、部署和新空副本复验。
