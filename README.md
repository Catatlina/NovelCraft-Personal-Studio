...
当前默认入口为「小说首页」（Starlume AI 小说优先）。小说主线只保留七项页面：小说首页、创作向导、我的书库、创作进度、章节编辑器、审阅与一致性、小说设置。非小说模块（扫榜、热点、发布、知识库、分发、协作、智能体等）已从产品 UI 隐藏——其历史数据与仍被后端主链使用的源码保留，不删除。详见 `docs/AI_HANDOFF.md` 与 `docs/KNOWN_ISSUES.md`（KI-004）。
